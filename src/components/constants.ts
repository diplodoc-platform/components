...
export const DOC_LEADING_PAGE_URL =
    BASE_URL + '/iframe.html?args=&id=pages-leading--leading&viewMode=story';
...
export const DOC_PAGE_MARKDOWN_ACTIONS_HIDDEN_URL =
    BASE_URL + '/iframe.html?args=MarkdownActions:none&id=pages-document--document&viewMode=story';
